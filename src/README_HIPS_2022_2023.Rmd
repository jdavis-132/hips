...
-   **Data Processing Notes:** GDDs were calculated using temperatures
    ...
    GDDs were visual outliers in the histogram and were dropped. In the 2022 inbreds, values greater than 3000 GDDs were visual outliers and converted to missing values. In the
